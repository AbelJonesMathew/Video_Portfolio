...
const TagCard = ({ number, title, text, className, aosDelay, aosType, pathLength, containerRef }) => {
  ...
  useMotionValueEvent(pathLength, "change", (latest) => {
    ...
    // Trigger entrance animation right as the drawing line approaches the top of the card (100px before reaching the card top)
    const appearY = cardTopRelativeToContainer - 100;
    if (lineTipY >= appearY && !isVisible) {
      setIsVisible(true);
    } else if (lineTipY < appearY && isVisible) {
      setIsVisible(false);
    }

    // Trigger red background punch when line tip is 50px into the card
  ...
  return (
    <motion.div 
      ref={ref}
      initial={{ opacity: 0, x: aosType === "fade-left" ? 60 : aosType === "fade-right" ? -60 : 0, y: 40 }}
      animate={{ 
        opacity: isVisible ? 1 : 0, 
        x: isVisible ? 0 : (aosType === "fade-left" ? 60 : aosType === "fade-right" ? -60 : 0), 
        y: isVisible ? 0 : 40 
      }}
      ...
      <div className="max-w-6xl mx-auto relative md:h-[1350px]">
        ...
        <div data-aos="fade-up" className="md:absolute top-10 left-0 md:w-[450px] z-20 mb-16 md:mb-0">
          ...
          <p className="text-gray-500 text-base md:text-lg max-w-sm font-medium leading-relaxed">
            My educational journey has been a path of continuous learning, growth, and perseverance.Throughout my studies, I have worked to improve my knowledge and skills by embracing challenges and learning from every experience.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-8 md:gap-12 items-center md:block relative z-10 w-full pt-4 md:pt-0 pb-12 md:pb-0">
          ...
          <TagCard 
            number="01"
            title="Kindergartens"
            text="My educational journey began at St. Kuriakose Nursery School (SKNS), Kaduthuruthy, where I completed my kindergarten education. My time there was filled with joyful learning, fun activities, and the first steps of my academic life."
          ...
          <TagCard 
            ...
            text="I completed my primary and secondary education (Classes 1 to 10) at Mary Mount Public School, Kattachira. My years at the school were filled with valuable learning experiences, meaningful friendships, and opportunities to grow both academically and personally."
          ...
          <TagCard 
            ...
            text="I completed my Higher Secondary education (Classes 11 and 12) at SFS Public School, Ettumanoor. During this period, I also prepared for competitive entrance examinations by attending coaching classes at Brilliant Study Centre. Balancing school studies with entrance coaching strengthened my subject knowledge, discipline, and determination to achieve my academic goals."
          ...
          <TagCard 
            number="04"
            title="College"
            text="I am currently pursuing B.Tech degree in Computer Science and Engineering. Through this program, I am gaining knowledge in programming, software development, computer networks, databases, and emerging technologies."
