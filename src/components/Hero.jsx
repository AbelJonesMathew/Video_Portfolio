...
const Hero = ({ preloaderDone }) => {
  ...
  const toggleVideo = (e) => {
    e.stopPropagation();
    if (videoRef.current) {
      if (videoRef.current.paused || videoRef.current.ended || isMuted) {
    ...
    <section id="home" className="relative w-full h-screen overflow-hidden bg-black">
      ...
      <div className="absolute inset-0 z-20 px-6 pb-20 md:pb-[8%] md:px-12 max-w-7xl mx-auto flex flex-col md:flex-row justify-end md:justify-between items-start md:items-end text-left w-full">
        ...
        <div className="flex flex-col items-start text-left max-w-2xl w-full">
          ...
          >
            Hi, I’m a <br /> <span className="text-transparent [-webkit-text-stroke:1.5px_black]">B.Tech Student</span>
          </h1>
          ...
          >
            At Saint Joseph`s College of Engineering and Technology, Palai (SJCET).
          </p>
          ...
          >
            {/* Primary Button */}
            <a href="https://github.com/AbelJonesMathew" className="px-4 py-2 md:px-6 md:py-2 text-xs md:text-base rounded-full bg-white text-black font-semibold hover:bg-gray-200 transition-all duration-300 transform hover:scale-105 shadow-md inline-block" target="_blank">
              View My Work
            </a>
