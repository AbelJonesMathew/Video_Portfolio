      ...
      {isLoading && (
        ...
        >
          ...
          <motion.div 
            ...
            className="relative text-3xl sm:text-5xl md:text-7xl font-black tracking-tighter"
          >
            {/* Background text (empty state) */}
            <div className="text-red-900/30">
              Abel Jones Mathew<span className="text-red-900/30">.</span>
            </div>
            ...
            >
              Abel Jones Mathew<span className="text-black">.</span>
            </motion.div>
          </motion.div>
